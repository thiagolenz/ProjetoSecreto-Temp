...
@WebServlet("/"+ServletConstants.FORGOTPASSWORD)
public class ForgotPasswordViewServlet extends HttpServlet {
	
	private final String createPage = "modules/login/template/forgotPassword.jsp";
	/**
	 * 
	 */
