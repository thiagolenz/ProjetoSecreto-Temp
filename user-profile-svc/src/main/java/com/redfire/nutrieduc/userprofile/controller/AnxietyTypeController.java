...
import com.redfire.nutrieduc.entities.consultation.AnxietyType;

@Controller
@RequestMapping(value="/anxietyType",produces=MediaType.APPLICATION_JSON_VALUE)

public class AnxietyTypeController {
	@Autowired
	...
	public @ResponseBody List<EnumSerializableBean> retrieveStatus () throws IOException {
		...
		for (AnxietyType type : AnxietyType.values()) {
