...
import com.redfire.nutrieduc.entities.consultation.IntestineFrequencyType;

@Controller
@RequestMapping(value="/intestineFrequencyType",produces=MediaType.APPLICATION_JSON_VALUE)

public class IntestineFrequencyTypeController {
	@Autowired
	...
	public @ResponseBody List<EnumSerializableBean> retrieveStatus () throws IOException {
		...
		for (IntestineFrequencyType type : IntestineFrequencyType.values()) {
